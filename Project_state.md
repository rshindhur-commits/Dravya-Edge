...
- The default `Trading` page is a live operations cockpit: canonical paper positions, material scanner decisions, ranked opportunities, active risk conditions, Telegram delivery status, market pulse, and a chronological event timeline. It deliberately excludes performance analysis, replay rationale, research learning, and developer health diagnostics, which remain owned by Reports, Replay/Validation, Learning, and Developer.
