...
- `TELEGRAM_ALERT_POLICY=PAPER` sends eligible `ENTER_PAPER` decisions when the decision score meets `TELEGRAM_MIN_ENTRY_ALERT_SCORE` and the shared decision has no block reasons.
