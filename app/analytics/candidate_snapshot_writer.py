...
def normalize_candidate_row(
    ...
    normalized_row = {
        ...
        "scanner_recommendation": _row_get(row, "Scanner Recommendation", "scanner_recommendation", "Action Status"),
        "execution_eligibility": _row_get(row, "Execution Eligibility", "execution_eligibility"),
        "execution_outcome": _row_get(row, "Execution Outcome", "execution_outcome"),
        "execution_reason": _row_get(row, "Execution Reason", "execution_reason"),
        "trade_status": _row_get(row, "Trade Status", "trade_status"),
        "telegram_status": _row_get(row, "Telegram Status", "telegram_status"),
        "telegram_reason": _row_get(row, "Telegram Reason", "telegram_reason"),
