...
SHADOW_COLUMNS = [
    ...
    "v2_exit_confidence_score",
    "v2_exit_health_state",
    "v2_soft_confirmation_count",
    "v2_soft_confirmation_streak",
    "v2_grace_zone_active",
    "v2_mfe_r",
    "v2_rr_progress",
...
def build_shadow_rows(rows, trading_day, scan_id, observed_at):
    ...
    for row in rows:
        ...
        records.append({
            ...
            "v2_exit_confidence_score": _value(row, "V2 Exit Confidence Score"),
            "v2_exit_health_state": _value(row, "V2 Exit Health State"),
            "v2_soft_confirmation_count": _value(row, "V2 Soft Confirmation Count"),
            "v2_soft_confirmation_streak": _value(row, "V2 Soft Confirmation Streak"),
            "v2_grace_zone_active": _value(row, "V2 Grace Zone Active"),
