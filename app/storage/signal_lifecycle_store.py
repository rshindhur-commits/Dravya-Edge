...
def _event_from_row(
    ...
    return {
        ...
        "option_quote_timestamp": _row_get(row, "option_quote_timestamp", "Option Quote Timestamp"),
        "option_quote_checked_at": _row_get(row, "option_quote_checked_at", "Option Quote Checked At"),
        "option_quote_timeframe": _row_get(row, "option_quote_timeframe", "Option Quote Timeframe"),
        "option_quote_source": _row_get(row, "option_quote_source", "Option Quote Source"),
        "option_quote_timestamp_field": _row_get(row, "option_quote_timestamp_field", "Option Quote Timestamp Field"),
        "option_quote_age_minutes": _row_get(row, "option_quote_age_minutes", "Option Quote Age Minutes"),
        "option_quote_age_seconds": _row_get(row, "option_quote_age_seconds", "Option Quote Age Seconds"),
        "option_quote_allowed_age_seconds": _row_get(row, "option_quote_allowed_age_seconds", "Option Quote Allowed Age Seconds"),
        "option_quote_freshness_reason": _row_get(row, "option_quote_freshness_reason", "Option Quote Freshness Reason"),
        "option_quote_retry_count": _row_get(row, "option_quote_retry_count", "Option Quote Retry Count"),
        "option_quote_latency_ms": _row_get(row, "option_quote_latency_ms", "Option Quote Latency Ms"),
        "option_quote_refresh_time": _row_get(row, "option_quote_refresh_time", "Option Quote Refresh Time"),
